...
public class Config_SQL_Server {
	...
	public Config_SQL_Server() {
		this.RDMS = "SQL Server";
		this.cadena_driver = "com.mysql.jdbc.Driver";
		this.bd_predeterminada_sistema = "";
		this.puerto_acceso = "1433";
		this.prefijo_conexion = "jdbc:sqlserver://";
	}
	...
	public String getCadena_conexion() {
		this.cadena_conexion = this.prefijo_conexion + this.bd_servidor + ":" + this.puerto_acceso + ";databaseName=" + this.bd_nombre;
		//FR_Util.trace("this.cadena_conexion >> " + this.cadena_conexion);
	...
	public String getConsulta_listar_bases_datos() {
		this.consulta_listar_bases_datos = "";
