...
public class URLUTF8Encoder {
	...
	public static String encode(String s) {
		//s = reemplazarCaracteresNosoportados(s);
	...
	public static String reemplazarCaracteresNosoportados_por_equivalenteHTML(String cadena) {
		String rpta = "";
		for (int i = 0; i < cadena.length(); i++) {
			...
			else if(cadena.charAt(i)=='º') {
				rpta += "&deg;";
			}
			else if(cadena.charAt(i)=='°') {//Otro tipo de bolita
				rpta += "&deg;";
			}
			else if(cadena.charAt(i)=='ú') {
				rpta += "&eacute;";
			...
			else if(cadena.charAt(i)=='à') {
				rpta += "&agrave;";
			}
			else if(cadena.charAt(i)=='è') {
				rpta += "&egrave;";
			}
			else if(cadena.charAt(i)=='ì') {
				rpta += "&igrave;";
			}
			else if(cadena.charAt(i)=='ò') {
				rpta += "&ograve;";
			}
			else if(cadena.charAt(i)=='ù') {
				rpta += "&ugrave;";
			}
			else if(cadena.charAt(i)=='¿') {
				rpta += "&iquest;";
			}
			else if(cadena.charAt(i)=='µ') {
				rpta += "&micro;";
			}
			else if(cadena.charAt(i)=='¨') {
				rpta += "&quot;";
			...
			rpta = rpta.replaceAll("&amp;nbsp;", "&nbsp;");
			rpta = rpta.replaceAll("Ã¡", "&aacute;");
        }
		return rpta;
	}
	
	public static String reemplazarCaracteresNosoportados_por_equivalenteUTF8(String cadena) {
		String rpta = "";
		/*
		for (int i = 0; i < cadena.length(); i++) {
			if(cadena.charAt(i)=='&') {
